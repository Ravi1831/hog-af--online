...
class ArtifactControllerTest {
    ...
    @Test
    void testFindArtifactIdNotFound() throws Exception {
        given(this.artifactService.findById("1250808601744904191"))
                .willThrow(new ObjectNotFoundException(ExceptionConstants.ARTIFACT, "1250808601744904191"));
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        Artifact savedArtifacts = new Artifact();
        savedArtifacts.setId("1250808601744904197");
        savedArtifacts.setName("Remembrall");
        savedArtifacts.setDescription("A Remembrall was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered.");
        savedArtifacts.setImageUrl("ImageUrl");

        given(this.artifactService.save(Mockito.any(Artifact.class))).willReturn(savedArtifacts);
        //when and then
        this.mockMvc.perform(MockMvcRequestBuilders.post(this.baseUrl+"/artifacts")
                ...
                .andExpect(jsonPath("$.data.name").value(savedArtifacts.getName()))
                .andExpect(jsonPath("$.data.description").value(savedArtifacts.getDescription()))
                .andExpect(jsonPath("$.data.imageUrl").value(savedArtifacts.getImageUrl()));
    }
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        //when and then
        this.mockMvc.perform(MockMvcRequestBuilders.put(this.baseUrl+"/artifacts/1250808601744904192")
    ...
    void testUpdateArtifactErrorWithNonExistenceId() throws Exception {
        ...
        given(this.artifactService.update(eq("1250808601744904192"),Mockito.any(Artifact.class)))
                .willThrow(new ObjectNotFoundException(ExceptionConstants.ARTIFACT, "1250808601744904192"));
    ...
    void testDeleteArtifactSuccess() throws Exception {
        ...
        //when and then
        this.mockMvc.perform(MockMvcRequestBuilders.delete(this.baseUrl+"/artifacts/1250808601744904191")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteArtifactErrorWithNonExistenceId() throws Exception {
        //given
        doThrow(new ObjectNotFoundException(ExceptionConstants.ARTIFACT, "1250808601744904191")).when(this.artifactService).delete("1250808601744904191");
        //when and then
        this.mockMvc.perform(MockMvcRequestBuilders.delete(this.baseUrl+"/artifacts/1250808601744904191")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
    ...
    void testSummarizeArtifactsSuccess() throws Exception {
        ...
        // When and then
        this.mockMvc.perform(MockMvcRequestBuilders.get(this.baseUrl + "/artifacts/summary").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
