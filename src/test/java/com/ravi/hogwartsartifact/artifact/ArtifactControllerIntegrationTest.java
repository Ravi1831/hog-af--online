...
class ArtifactControllerIntegrationTest {
    ...
    @Test
    @DisplayName("Find artifact having description with JPA Specification (POST)")
    ...
    @Test
    @DisplayName("Find artifact having name and description with JPA Specification (POST)")
